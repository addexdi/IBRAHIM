...
const exportType = {
    body: [`export type ${types_1.Placeholders.FirstTab} = {${types_1.Placeholders.LastTab}}`],
    key: 'exportType',
    prefix: 'exptp',
};
const exportInterface = {
    ...
    prefix: 'expint',
    body: [
        `export interface ${types_1.Placeholders.FirstTab} {${types_1.Placeholders.LastTab}}`,
        '',
    ],
};
...
const typescriptReactNativeArrowFunctionComponent = {
    ...
    body: [
        ...
        '  return (',
        '    <View>',
        `      <Text>${types_1.Placeholders.LastTab}</Text>`,
        '    </View>',
        '  )',
        '}',
        ...sharedSnippets_1.exportDefault,
...
const typescriptReactNativeArrowFunctionComponentNamedProps = {
    ...
    body: [
        ...
        ...sharedSnippets_1.react,
        ...sharedSnippets_1.propsTypeInterface,
        `const ${types_1.Placeholders.FileName}: React.FC<${types_1.Placeholders.FileName}Props> = (props) => {`,
        '  return (',
        '    <View>',
