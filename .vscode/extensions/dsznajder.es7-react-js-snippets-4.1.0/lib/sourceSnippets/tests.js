...
const describeBlock = {
    ...
    prefix: 'desc',
    body: [
        `describe('${types_1.Placeholders.FirstTab}', () => {`,
...
const testBlock = {
    ...
    prefix: 'test',
    body: [
        `test('should ${types_1.Placeholders.FirstTab}', () => {`,
        `  ${types_1.Placeholders.LastTab}`,
        '})',
        '',
    ],
...
const testAsyncBlock = {
    ...
    prefix: 'testa',
    body: [
        `test('should ${types_1.Placeholders.FirstTab}', async () => {`,
        `  ${types_1.Placeholders.LastTab}`,
        '})',
        '',
    ],
...
const itBlock = {
    ...
    prefix: 'tit',
    body: [
        `it('should ${types_1.Placeholders.FirstTab}', () => {`,
        `  ${types_1.Placeholders.LastTab}`,
        '})',
        '',
    ],
...
const itAsyncBlock = {
    ...
    prefix: 'tita',
    body: [
        `it('should ${types_1.Placeholders.FirstTab}', async () => {`,
        `  ${types_1.Placeholders.LastTab}`,
        '})',
        '',
    ],
