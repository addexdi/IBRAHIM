...
exports.pushProgress = void 0;
const vscode = __importStar(require("vscode"));
const pushProgressResolver_1 = require("../services/pushProgressResolver");
function pushProgress(term, statBar) {
    return vscode.commands.registerCommand('git.pushProgress', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            pushProgressResolver_1.gitPush(term, statBar)
                .then(output => {
...
exports.pushProgress = pushProgress;
//# sourceMappingURL=pushProgress.js.map